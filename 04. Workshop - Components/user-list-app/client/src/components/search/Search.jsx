...
export default function Search({ onSearch }) {
    ...
    const criteriaChangeHandler = (e) => setSearchCriteria(e.currentTarget.value);
    const searchChangeHandler = (e) => setSearchValue(e.currentTarget.value);
    ...
    return (
        <form className="search-form" onSubmit={handleSubmit}>
            ...
            <button className="btn close-btn" onClick={() => setSearchValue('')}>
